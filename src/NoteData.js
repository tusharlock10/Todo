...
const NoteData = [
    ...
    {text:(<Text style={styles.TextStyling}>
        ...
        </Text>), image: require('../assets/images/DeleteDemo.png'), imgSizeSub:20},

    {text:(<Text style={styles.TextStyling}>
        Increase the volume for <Text style={{color:"rgb(150,113, 187)"}}>SOUND</Text> effects
        </Text>), image: require('../assets/images/volume.png'), imgSizeSub:280},

    {text:(<Text style={styles.TextStyling}>
        Don't forget to <Text style={{color:"rgb(219, 22, 47)"}}>SAVE</Text> your
        todo, when completed writing
        </Text>), image: require('../assets/images/PressSaveButton.png'), imgSizeSub:120},

    {text:(<Text style={styles.TextStyling}>
        To clear all of your TODOs at <Text style={{color:"rgb(220, 62, 62)"}}>ONCE</Text>,
        tap on the cross
        </Text>), image: require('../assets/images/PressCrossButton.png'), imgSizeSub:120},

    {text:(<Text style={styles.TextStyling}>
        Now, press the <Text style={{color:"rgb(0,161,255)"}}>BUTTON</Text> below to start
        </Text>), image: require('../assets/images/PressAddButton.png'), imgSizeSub:120},
